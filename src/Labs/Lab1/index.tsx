export default function Lab1() {
    return (
      <div id="wd-lab1">
        <h2>Name: Jiaming Pei</h2>
        <h3>Section: CS5610 Online 25Summer 2</h3>
        <h2>Lab 1</h2>
        <h3>HTML Examples</h3>
        ...
        <div id="wd-lists">
          ...
          <ol id="wd-my-favorite-recipe">
            ...
            <li>Mix and prepare as needed.</li>
            <li>Cook or bake to perfection!</li>
          </ol>
        ...
        <h4>Anchor tag</h4>
        <span>Please</span> <a href="https://www.lipsum.com" id="wd-lipsum">click here</a>
        <span> to get dummy text</span><br/>

        <a href="https://github.com/TomatoesSuck" id="wd-github">Github</a><br/>
