  ...
  return (
    <div>
      ...
      <div id="wd-css-styling-switches">
        <h3>Switches</h3>
        <FormCheck type="switch" id="wd-switch-1" label="Unchecked switch" />
        <FormCheck type="switch" id="wd-switch-2" label="Checked switch" defaultChecked />
        <FormCheck type="switch" id="wd-switch-3" label="Disabled switch" disabled />
        <FormCheck type="switch" id="wd-switch-4" label="Checked disabled switch" defaultChecked disabled />
      </div>
          ...
          <fieldset>
            <Form.Group as={Row} className="mb-3">
              ...
              <Col sm={10}>
                ...
                <Form.Check type="radio" label="third radio" name="formHorizontalRadios" id="radio3" />
              </Col>
            </Form.Group>
          </fieldset>
          <Form.Group as={Row} className="mb-3">
